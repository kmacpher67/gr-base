...
<html>
    ...
    <body>
        ...
        <div id="show-appStatus" class="content scaffold-show" role="main">
            ...
            <f:display bean="appStatus" />
            <g:form resource="${this.appStatus}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.appStatus}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
