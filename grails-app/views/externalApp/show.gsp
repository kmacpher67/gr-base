...
<html>
    ...
    <body>
        ...
        <div id="show-externalApp" class="content scaffold-show" role="main">
            <h1><g:message code="default.show.label" args="[entityName]" /></h1>
            <g:if test="${flash.message}">
            <div class="message" role="status">${flash.message}</div>
            </g:if>
            <f:display bean="externalApp" />
            <g:form resource="${this.externalApp}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.externalApp}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
