...
class FacebookAuthService {
    ...
    Map onJsonFailure(Map input, AuthenticationException exception) {
		log.info("onJsonFailure map=" + input)
    ...
    FacebookUser create(FacebookAuthToken token) {
        log.info("Create domain for kenny ken facebook user $token.uid")
		
		print("FacebookUser create(FacebookAuthToken token)!!!")
        ...
        log.info("Create domain         person.save()")
        person.save()
        ...
        fbUser.save()
		        log.info("Create domain         fbUser.save()" + fbUser.accessToken)
		        log.info("Create domain         fbUser.save()" + fbUser.accessTokenExpires)

        X_createRoles(fbUser)
        log.info("Create domain         rolly polley")
